...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      // Trade Republic card
      'tr.badge':        'Mejor neobroker',
      'tr.fees':         '1€/operación',
      'tr.type':         'Neobroker',
      'tr.markets':      'Acciones · ETFs · Criptos · Bonos',
      'tr.pro1':         'App móvil muy intuitiva y rápida',
      'tr.pro2':         'Planes de ahorro automáticos gratis',
      'tr.pro3':         'Cuenta remunerada al 3% TAE',
      'tr.con1':         'Solo disponible vía app (sin web)',
      'tr.con2':         '1€ de comisión por operación puntual',
      'tr.cta':          'Abrir cuenta + acción gratis →',
      'tr.regulated':    '🔒 Regulado BaFin',
      'tr.note':         '* Enlace de afiliado — sin coste para ti. Ambos recibís una acción gratis.',
      'tr.steps.title':  '🎁 Cómo usar el enlace de referido (¡acción gratis!)',
      'tr.step1':        'Pulsa el botón y descarga la app de Trade Republic',
      'tr.step2':        'Crea tu cuenta e introduce el código de referido cuando te lo pidan',
      'tr.step3':        'Verifica tu identidad (DNI/NIE) en la propia app',
      'tr.step4':        'Realiza tu primera inversión desde 1€ (acción, ETF o plan de ahorro)',
      'tr.step5':        '¡Listo! Ambos recibiréis una acción gratis valorada hasta 200€',
      // Table
    ...
    en: {
      ...
      // Trade Republic card
      'tr.badge':        'Best neobroker',
      'tr.fees':         '€1/trade',
      'tr.type':         'Neobroker',
      'tr.markets':      'Stocks · ETFs · Cryptos · Bonds',
      'tr.pro1':         'Very intuitive and fast mobile app',
      'tr.pro2':         'Free automatic savings plans',
      'tr.pro3':         '3% APY interest account',
      'tr.con1':         'App only (no web platform)',
      'tr.con2':         '€1 fee per individual trade',
      'tr.cta':          'Open account + free share →',
      'tr.regulated':    '🔒 Regulated BaFin',
      'tr.note':         '* Affiliate link — no extra cost for you. Both get a free share.',
      'tr.steps.title':  '🎁 How to use the referral link (free share!)',
      'tr.step1':        'Tap the button and download the Trade Republic app',
      'tr.step2':        'Create your account and enter the referral code when prompted',
      'tr.step3':        'Verify your identity (ID/passport) in the app',
      'tr.step4':        'Make your first investment from €1 (stock, ETF or savings plan)',
      'tr.step5':        'Done! You both receive a free share worth up to €200',
      // Table
